...
public class Gui extends GuiComponent {
   ...
   protected final List<ChatListener> f_92979_;
   ...
   public Gui(Minecraft p_232355_, ItemRenderer p_232356_) {
      ...
      this.f_92979_ = List.of(new StandardChatListener(p_232355_), NarratorChatListener.LOGGER, new OverlayChatListener(p_232355_));
   ...
   public void m_232360_(ChatType p_232361_, Component p_232362_, ChatSender p_232363_) {
      if (!this.minecraft.isBlocked(p_232363_.f_236980_())) {
         if (!this.minecraft.options.hideMatchedNames().get() || !this.minecraft.isBlocked(this.m_93074_(p_232362_))) {
            for(ChatListener chatlistener : this.f_92979_) {
               chatlistener.m_213924_(p_232361_, p_232362_, p_232363_);
            }
   ...
   public void m_232357_(ChatType p_232358_, Component p_232359_) {
      if (!this.minecraft.options.hideMatchedNames().get() || !this.minecraft.isBlocked(this.m_93074_(p_232359_))) {
         for(ChatListener chatlistener : this.f_92979_) {
            chatlistener.m_213924_(p_232358_, p_232359_, (ChatSender)null);
         }
