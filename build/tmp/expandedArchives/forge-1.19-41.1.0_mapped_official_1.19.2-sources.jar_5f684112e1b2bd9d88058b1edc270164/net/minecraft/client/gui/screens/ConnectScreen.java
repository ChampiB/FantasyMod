...
public class ConnectScreen extends Screen {
      ...
      Thread thread = new Thread("Server Connector #" + UNIQUE_THREAD_ID.incrementAndGet()) {
         public void run() {
            ...
            try {
               ...
               ConnectScreen.this.connection.send(new ServerboundHelloPacket(p_169265_.getUser().getName(), p_169265_.getProfileKeyPairManager().m_233793_()));
   ...
   public void render(PoseStack p_95700_, int p_95701_, int p_95702_, float p_95703_) {
      ...
      if (i - this.lastNarration > 2000L) {
         ...
         NarratorChatListener.LOGGER.sayNow(Component.translatable("narrator.joining"));
      }
