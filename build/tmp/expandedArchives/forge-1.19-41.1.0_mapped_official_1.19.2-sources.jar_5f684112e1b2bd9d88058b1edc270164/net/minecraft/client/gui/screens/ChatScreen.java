...
public class ChatScreen extends Screen {
   ...
   private static final Component f_232697_ = Component.translatable("chat.preview").withStyle(ChatFormatting.DARK_GRAY);
   ...
   private void requestCommandArgumentPreview(String p_232725_) {
      ...
      if (commandnode != null && PreviewedArgument.m_232862_(commandnode)) {
   ...
   public boolean keyPressed(int p_95591_, int p_95592_, int p_95593_) {
      if (this.commandSuggestions.keyPressed(p_95591_, p_95592_, p_95593_)) {
         ...
         this.m_232710_(this.input.getValue(), true);
         this.minecraft.setScreen((Screen)null);
         return true;
      }
   }
   ...
   public void render(PoseStack p_95595_, int p_95596_, int p_95597_, float p_95598_) {
      ...
      if (this.chatPreview.m_232424_()) {
         this.m_232704_(p_95595_);
      } else {
   ...
   public void m_232704_(PoseStack p_232705_) {
      ...
      List<FormattedCharSequence> list = this.m_232728_();
   ...
   private List<FormattedCharSequence> m_232728_() {
      Component component = this.chatPreview.m_232421_();
      return component != null ? this.font.split(component, this.chatPreviewWidth()) : List.of(f_232697_.getVisualOrderText());
   }
   ...
   public void m_232710_(String p_232711_, boolean p_232712_) {
      ...
      if (!p_232711_.isEmpty()) {
         ...
         Component component = this.chatPreview.m_232419_(p_232711_);
         if (p_232711_.startsWith("/")) {
            this.minecraft.player.commandSigned(p_232711_.substring(1), component);
         } else {
            this.minecraft.player.m_234125_(p_232711_, component);
         }
