...
public class ConfirmScreen extends Screen {
   ...
   public Component getNarrationMessage() {
      return CommonComponents.joinForNarration(super.getNarrationMessage(), this.f_95650_);
   }

   protected void init() {
      super.init();
      this.message = MultiLineLabel.create(this.font, this.f_95650_, this.width - 50);
