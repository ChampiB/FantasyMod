...
public class SelectWorldScreen extends Screen {
   ...
   protected void init() {
      ...
      this.searchBox.setResponder((p_232980_) -> {
         this.list.m_233193_(p_232980_);
      });
      this.list = new WorldSelectionList(this, this.minecraft, this.width, this.height, 48, this.height - 64, 36, this.m_232985_(), this.list);
   ...
   public Supplier<String> m_232985_() {
      return () -> {
