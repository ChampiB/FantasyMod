...
public class Options {
   ...
   private static final Component f_231795_ = Component.translatable("options.chatPreview.tooltip");
   private final OptionInstance<Boolean> chatPreview = OptionInstance.createBoolean("options.chatPreview", OptionInstance.cachedConstantTooltip(f_231795_), true);
   ...
   private final OptionInstance<NarratorStatus> narrator = new OptionInstance<>("options.narrator", OptionInstance.noTooltip(), (p_231907_, p_231908_) -> {
      return (Component)(NarratorChatListener.LOGGER.isActive() ? p_231908_.getName() : Component.translatable("options.narrator.notavailable"));
      ...
      NarratorChatListener.LOGGER.updateNarratorStatus(p_231860_);
   });
