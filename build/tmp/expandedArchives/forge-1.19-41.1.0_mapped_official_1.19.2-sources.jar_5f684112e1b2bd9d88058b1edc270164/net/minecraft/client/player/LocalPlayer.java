...
public class LocalPlayer extends AbstractClientPlayer {
   ...
   public void m_108739_(String p_108740_) {
      this.m_234125_(p_108740_, (Component)null);
   }
   ...
   public void m_234156_(String p_234157_) {
      this.commandSigned(p_234157_, (Component)null);
   }

   public void commandSigned(String p_234149_, @Nullable Component p_234150_) {
      MessageSigner messagesigner = MessageSigner.create(this.getUUID());
      this.m_234151_(messagesigner, p_234149_, p_234150_);
   }

   private void m_234141_(MessageSigner p_234142_, String p_234143_, @Nullable Component p_234144_) {
      if (p_234144_ != null) {
         MessageSignature messagesignature = this.m_234145_(p_234142_, p_234144_);
         this.connection.send(new ServerboundChatPacket(p_234143_, messagesignature, true));
      } else {
         MessageSignature messagesignature1 = this.m_234145_(p_234142_, Component.literal(p_234143_));
         this.connection.send(new ServerboundChatPacket(p_234143_, messagesignature1, false));
      }

   }

   private MessageSignature m_234145_(MessageSigner p_234146_, Component p_234147_) {
      try {
         Signer signer = this.minecraft.getProfileKeyPairManager().signer();
         if (signer != null) {
            return p_234146_.m_237180_(signer, p_234147_);
         }
   ...
   private ArgumentSignatures m_234137_(MessageSigner p_234138_, ParseResults<SharedSuggestionProvider> p_234139_, @Nullable Component p_234140_) {
      Map<String, Component> map = ArgumentSignatures.m_231054_(p_234139_.getContext());
      if (map.isEmpty()) {
         return ArgumentSignatures.m_231053_();
      } else {
         Signer signer = this.minecraft.getProfileKeyPairManager().signer();
         if (signer == null) {
            return ArgumentSignatures.m_231053_();
            ...
            try {
               ...
               map.forEach((p_234135_, p_234136_) -> {
                  ...
                  MessageSignature messagesignature = p_234138_.m_237180_(signer, component);
                  builder.put(p_234135_, messagesignature.f_237138_().signature());
               });
