...
public interface PreviewedArgument<T> extends ArgumentType<T> {
   @Nullable
   static CompletableFuture<Component> m_232859_(ArgumentCommandNode<?, ?> p_232860_, CommandContextBuilder<CommandSourceStack> p_232861_) throws CommandSyntaxException {
      ArgumentType argumenttype = p_232860_.getType();
      if (argumenttype instanceof PreviewedArgument<?> previewedargument) {
         return previewedargument.m_232856_(p_232861_, p_232860_.getName());
      } else {
         return null;
      }
   }

   static boolean m_232862_(CommandNode<?> p_232863_) {
   ...
   @Nullable
   default CompletableFuture<Component> m_232856_(CommandContextBuilder<CommandSourceStack> p_232857_, String p_232858_) throws CommandSyntaxException {
