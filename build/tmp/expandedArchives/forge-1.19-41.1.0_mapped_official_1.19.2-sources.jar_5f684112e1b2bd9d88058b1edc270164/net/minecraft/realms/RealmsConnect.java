...
public class RealmsConnect {
   ...
   public void connect(final RealmsServer p_175032_, ServerAddress p_175033_) {
      ...
      NarratorChatListener.LOGGER.sayNow(Component.translatable("mco.connect.success"));
      ...
      (new Thread("Realms-connect-task") {
         public void run() {
            ...
            try {
               ...
               RealmsConnect.this.connection.send(new ServerboundHelloPacket(s1, minecraft.getProfileKeyPairManager().m_233793_()));
