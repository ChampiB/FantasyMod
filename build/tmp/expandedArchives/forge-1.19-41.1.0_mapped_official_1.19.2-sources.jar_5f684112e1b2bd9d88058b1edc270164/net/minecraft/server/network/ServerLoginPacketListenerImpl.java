...
public class ServerLoginPacketListenerImpl implements ServerLoginPacketListener {
   ...
   private static final Component f_215252_ = Component.translatable("multiplayer.disconnect.missing_public_key");
   private static final Component f_215253_ = Component.translatable("multiplayer.disconnect.invalid_public_key_signature");
   private static final Component f_215254_ = Component.translatable("multiplayer.disconnect.invalid_public_key");
   ...
   @Nullable
   private ProfilePublicKey f_215255_;
   ...
   public void handleAcceptedLogin() {
      ...
      if (component != null) {
         ...
         if (this.server.getCompressionThreshold() >= 0 && !this.connection.isMemoryConnection()) {
            this.connection.m_129514_(new ClientboundLoginCompressionPacket(this.server.getCompressionThreshold()), (p_10041_) -> {
         ...
         try {
            ServerPlayer serverplayer1 = this.server.getPlayerList().getPlayerForLogin(this.gameProfile, this.f_215255_);
            if (serverplayer != null) {
   ...
   private static ProfilePublicKey validatePublicKey(ServerboundHelloPacket p_215257_, SignatureValidator p_215258_, boolean p_215259_) throws ServerLoginPacketListenerImpl.PublicKeyParseException {
      try {
         ...
         if (optional.isEmpty()) {
            if (p_215259_) {
               throw new ServerLoginPacketListenerImpl.PublicKeyParseException(f_215252_);
            } else {
               return null;
            }
         } else {
            return ProfilePublicKey.m_219786_(p_215258_, optional.get());
         }
      } catch (InsecurePublicKeyException.MissingException missingexception) {
         if (p_215259_) {
            throw new ServerLoginPacketListenerImpl.PublicKeyParseException(f_215253_, missingexception);
         } else {
            return null;
         }
      } catch (CryptException cryptexception) {
         throw new ServerLoginPacketListenerImpl.PublicKeyParseException(f_215254_, cryptexception);
      } catch (Exception exception) {
         throw new ServerLoginPacketListenerImpl.PublicKeyParseException(f_215253_, exception);
      }
   }
   ...
   public void handleHello(ServerboundHelloPacket p_10047_) {
      ...
      try {
         this.f_215255_ = validatePublicKey(p_10047_, this.server.getServiceSignatureValidator(), this.server.enforceSecureProfile());
   ...
   public void handleKey(ServerboundKeyPacket p_10049_) {
      ...
      try {
         ...
         if (this.f_215255_ != null) {
            if (!p_10049_.isChallengeSignatureValid(this.nonce, this.f_215255_)) {
