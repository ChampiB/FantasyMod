...
public class MsgCommand {
   ...
   private static int sendMessage(CommandSourceStack p_214523_, Collection<ServerPlayer> p_214524_, MessageArgument.ChatMessage p_214525_) {
      if (p_214524_.isEmpty()) {
         ...
         p_214525_.m_232174_(p_214523_).thenAcceptAsync((p_214529_) -> {
            ...
            for(ServerPlayer serverplayer : p_214524_) {
               ...
               PlayerChatMessage playerchatmessage = p_214529_.m_215178_(p_214523_, serverplayer);
               if (playerchatmessage != null) {
                  serverplayer.m_215105_(playerchatmessage, p_214523_.asChatSender(), ChatType.f_237007_);
               }
            }
