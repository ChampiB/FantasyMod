...
public class RealmsMainScreen extends RealmsScreen {
   ...
   static final RealmsDataFetcher f_86255_ = new RealmsDataFetcher(Minecraft.getInstance(), RealmsClient.create());
   ...
   public void init() {
      ...
      if (realmsGenericErrorScreen != null) {
         ...
         this.hasUnreadNews = f_86255_.m_87854_();
         this.newsLink = f_86255_.m_87855_();
         this.numberOfPendingInvites = f_86255_.m_87851_();
      }
   }
      ...
      if (hasParentalConsent()) {
         ...
         if (f_86255_.m_87820_(RealmsDataFetcher.Task.PENDING_INVITE)) {
            ...
            if (this.numberOfPendingInvites > 0 && this.inviteNarrationLimiter.tryAcquire(1)) {
               NarratorChatListener.LOGGER.sayNow(Component.translatable("mco.configure.world.invite.narration", this.numberOfPendingInvites));
            }
         }

         if (f_86255_.m_87820_(RealmsDataFetcher.Task.TRIAL_AVAILABLE) && !this.createdTrial) {
            boolean flag3 = f_86255_.m_87852_();
   ...
   void removeServer(RealmsServer p_86677_) {
      this.realmsServers = f_86255_.m_210672_(p_86677_);
   ...
   private void drawPopup(PoseStack p_202330_) {
      ...
      if (!this.showingPopup) {
         ...
         NarratorChatListener.LOGGER.sayNow(POPUP_TEXT);
      }
